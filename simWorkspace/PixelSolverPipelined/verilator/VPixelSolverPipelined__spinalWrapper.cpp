...
#endif
#include "VPixelSolverPipelined__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_cmd_valid );
      signalAccess[1] = new CDataSignalAccess( top.io_cmd_ready );
      signalAccess[2] = new IDataSignalAccess( top.io_cmd_payload_x );
      signalAccess[3] = new IDataSignalAccess( top.io_cmd_payload_y );
      signalAccess[4] = new CDataSignalAccess( top.io_rsp_valid );
      signalAccess[5] = new CDataSignalAccess( top.io_rsp_ready );
      signalAccess[6] = new CDataSignalAccess( top.io_rsp_payload_iteration );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/BCAM/./simWorkspace/PixelSolverPipelined/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/BCAM/./simWorkspace/PixelSolverPipelined/") + name + ".dat").c_str());
      #endif
    }
