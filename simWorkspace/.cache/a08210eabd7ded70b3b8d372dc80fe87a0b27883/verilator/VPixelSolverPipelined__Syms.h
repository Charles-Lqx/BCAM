...
#include "VPixelSolverPipelined_PixelSolverPipelined.h"
...
class VPixelSolverPipelined__Syms final : public VerilatedSyms {
  public:
    ...
    VPixelSolverPipelined_PixelSolverPipelined TOP__PixelSolverPipelined;

    // SCOPE NAMES
    VerilatedScope __Vscope_PixelSolverPipelined;
