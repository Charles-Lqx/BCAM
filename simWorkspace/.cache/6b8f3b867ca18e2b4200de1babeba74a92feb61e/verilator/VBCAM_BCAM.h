...
VL_MODULE(VBCAM_BCAM) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ SegWr;
        CData/*0:0*/ STiWr;
        CData/*0:0*/ halfRateMPatt_valid;
        CData/*0:0*/ halfRateMPatt_ready;
        CData/*1:0*/ halfRateMPatt_payload_mPatt;
        CData/*0:0*/ __PVT__io_mPattStream_rValid;
        CData/*1:0*/ __PVT__io_mPattStream_rData_mPatt;
        CData/*1:0*/ mPattTwoPipe_0;
        CData/*1:0*/ mPattTwoPipe_1;
        CData/*1:0*/ mPattTwoPipe_2;
        CData/*0:0*/ mIndcStream_valid;
        CData/*0:0*/ mIndcStream_ready;
        CData/*3:0*/ mIndcStream_payload;
        CData/*0:0*/ __PVT___zz_mIndcStream_valid;
        CData/*0:0*/ __PVT__mIndcStream_isFree;
        CData/*3:0*/ __PVT__mIndcStream_payload_ohFirst_masked;
        CData/*1:0*/ SegAddr;
        CData/*1:0*/ __PVT__SegAddr_regNext;
        CData/*0:0*/ rMatch;
        CData/*0:0*/ __PVT__mIndcStream_rValid;
        CData/*3:0*/ __PVT__mIndcStream_rData;
        CData/*0:0*/ __PVT__mIndcStream_fire_1;
