...
VL_MODULE(VBCAM_BCAM) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__when_BCAM_l173;
        CData/*0:0*/ rWrStage1;
        CData/*0:0*/ rWrStage2;
        CData/*2:0*/ rWAddr;
        CData/*1:0*/ rWPatt;
        ...
        CData/*3:0*/ MIndc;
        CData/*0:0*/ __PVT__when_BCAM_l191;
        CData/*0:0*/ __PVT__when_BCAM_l192;
        CData/*3:0*/ __PVT__MIndc_ohFirst_masked;
        CData/*1:0*/ SegAddr;
        CData/*1:0*/ __PVT__SegAddr_regNext;
        CData/*0:0*/ rMatch;
        CData/*1:0*/ __PVT___zz_when_BCAM_l207_1;
        CData/*1:0*/ __PVT___zz_when_BCAM_l207_2;
