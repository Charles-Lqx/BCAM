...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[11] = new CDataSignalAccess( top.io_MAddrStream_payload_Match );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/lqx/IdeaProjects/BCAM/./simWorkspace/BCAM/") + name + ".fst").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/lqx/IdeaProjects/BCAM/./simWorkspace/BCAM/") + name + ".dat").c_str());
      #endif
    }
